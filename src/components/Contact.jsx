    ...
    <>
      <div className="block scroll-mt-(--scroll-offset)" id="contact">
        ...
        <section className="section-contact relative isolate w-full max-w-none scroll-mt-(--scroll-offset) overflow-visible bg-white px-0 pt-0 pb-[clamp(2.75rem,6vw,4.5rem)]" id="contact-form">
          <div className="contact-banner pointer-events-none relative z-0 h-55 w-full overflow-hidden md:h-77.5" aria-hidden="true">
            <div className="contact-parallax-bg absolute -top-55 right-0 -bottom-55 left-0 z-0 bg-[url('/assets/img/riyadh-skyline.jpg')] bg-cover bg-center bg-no-repeat transform-[translate3d(0,var(--contact-parallax-y,0px),0)] will-change-transform motion-reduce:transform-[translate3d(0,0,0)] motion-reduce:will-change-auto"></div>
          ...
          <div className="relative z-2 mx-auto -mt-27 w-full max-w-(--shell) px-(--gutter) md:-mt-38.75">
            <div className="contact-unified-card reveal block overflow-hidden rounded-[22px] border border-[color-mix(in_srgb,var(--color-brown)_8%,transparent)] bg-white px-7 py-9 shadow-[0_2px_10px_color-mix(in_srgb,var(--color-brown)_5%,transparent),0_18px_44px_color-mix(in_srgb,var(--color-brown)_7%,transparent),0_12px_36px_color-mix(in_srgb,var(--color-primary)_16%,transparent)] min-[760px]:grid min-[760px]:grid-cols-[minmax(0,1.18fr)_minmax(320px,.82fr)] min-[760px]:items-stretch min-[760px]:px-16 min-[760px]:py-14" data-delay="1">
                ...
                <form className="grid min-w-0 gap-4 border-0 bg-transparent p-0 shadow-none" id="contactForm" noValidate>
                  ...
                  <div className="grid gap-4 sm:grid-cols-2">
                    <p className="grid gap-[.45rem]">
                      <label className="text-(length:--fs-body) leading-normal font-(--w-body) text-lam-brown" htmlFor="cName">الاسم الكامل <span className="text-lam-primary" aria-hidden="true">*</span></label>
                      <span className="field-wrap relative block [&:focus-within_svg]:text-lam-primary">
                        ...
                        <input className="input peer min-h-13 w-full rounded-lam-md border border-(--color-neutral-border) bg-white py-[.85rem] pr-[2.9rem] pl-4.5 text-(length:--fs-body) leading-[1.6] text-lam-brown shadow-none transition-[border-color,box-shadow,background] duration-(--t-fast) ease-(--ease) placeholder:text-(--color-placeholder) hover:border-(--color-neutral-border) focus:border-lam-primary focus:bg-white focus:shadow-[0_0_0_3px_color-mix(in_srgb,var(--color-primary)_18%,transparent)] focus:outline-0 focus-visible:outline-0 [&.is-filled]:border-lam-primary [&.is-filled]:shadow-[0_0_0_3px_color-mix(in_srgb,var(--color-primary)_14%,transparent)] aria-invalid:border-lam-danger aria-invalid:bg-lam-surface aria-invalid:shadow-[0_0_0_4px_color-mix(in_srgb,var(--color-danger)_12%,transparent)]" id="cName" name="name" type="text" autoComplete="name" required placeholder="اسمِك الكامل" />
                      </span>
                      <span className="text-(length:--fs-small) leading-normal font-bold text-lam-danger empty:hidden" data-err-for="cName"></span>
                    </p>

                    <p className="grid gap-[.45rem]">
                      <label className="text-(length:--fs-body) leading-normal font-(--w-body) text-lam-brown" htmlFor="cPhone">رقم الجوال <span className="text-lam-primary" aria-hidden="true">*</span></label>
                      <span className="field-wrap relative block [&:focus-within_svg]:text-lam-primary">
                        ...
                        <input className="input min-h-13 w-full rounded-lam-md border border-(--color-neutral-border) bg-white py-[.85rem] pr-[2.9rem] pl-4.5 text-(length:--fs-body) leading-[1.6] text-lam-brown shadow-none transition-[border-color,box-shadow,background] duration-(--t-fast) ease-(--ease) placeholder:text-(--color-placeholder) hover:border-(--color-neutral-border) focus:border-lam-primary focus:bg-white focus:shadow-[0_0_0_3px_color-mix(in_srgb,var(--color-primary)_18%,transparent)] focus:outline-0 focus-visible:outline-0 [&.is-filled]:border-lam-primary [&.is-filled]:shadow-[0_0_0_3px_color-mix(in_srgb,var(--color-primary)_14%,transparent)] aria-invalid:border-lam-danger aria-invalid:bg-lam-surface aria-invalid:shadow-[0_0_0_4px_color-mix(in_srgb,var(--color-danger)_12%,transparent)]" id="cPhone" name="phone" type="tel" inputMode="tel" dir="ltr"
                          autoComplete="tel" required placeholder="05XXXXXXXX" />
                      </span>
                      <span className="text-(length:--fs-small) leading-normal font-bold text-lam-danger empty:hidden" data-err-for="cPhone"></span>
                    </p>
                  </div>

                  <div className="grid gap-4 sm:grid-cols-2">
                    <p className="grid gap-[.45rem]">
                      <label className="text-(length:--fs-body) leading-normal font-(--w-body) text-lam-brown" htmlFor="cWeight">الوزن <span className="text-[.8438rem] text-lam-subtle">(كجم)</span> <span className="text-lam-primary" aria-hidden="true">*</span></label>
                      <span className="field-wrap relative block [&:focus-within_svg]:text-lam-primary">
                        ...
                        <input className="input min-h-13 w-full rounded-lam-md border border-(--color-neutral-border) bg-white py-[.85rem] pr-[2.9rem] pl-4.5 text-(length:--fs-body) leading-[1.6] text-lam-brown shadow-none transition-[border-color,box-shadow,background] duration-(--t-fast) ease-(--ease) placeholder:text-(--color-placeholder) hover:border-(--color-neutral-border) focus:border-lam-primary focus:bg-white focus:shadow-[0_0_0_3px_color-mix(in_srgb,var(--color-primary)_18%,transparent)] focus:outline-0 focus-visible:outline-0 [&.is-filled]:border-lam-primary [&.is-filled]:shadow-[0_0_0_3px_color-mix(in_srgb,var(--color-primary)_14%,transparent)] aria-invalid:border-lam-danger aria-invalid:bg-lam-surface aria-invalid:shadow-[0_0_0_4px_color-mix(in_srgb,var(--color-danger)_12%,transparent)]" id="cWeight" name="weight" type="number" inputMode="decimal" dir="ltr"
                          min="30" max="250" step="0.1" placeholder="65" required />
                      </span>
                      <span className="text-(length:--fs-small) leading-normal font-bold text-lam-danger empty:hidden" data-err-for="cWeight"></span>
                    </p>

                    <p className="grid gap-[.45rem]">
                      <label className="text-(length:--fs-body) leading-normal font-(--w-body) text-lam-brown" htmlFor="cHeight">الطول <span className="text-[.8438rem] text-lam-subtle">(سم)</span> <span className="text-lam-primary" aria-hidden="true">*</span></label>
                      <span className="field-wrap relative block [&:focus-within_svg]:text-lam-primary">
                        ...
                        <input className="input min-h-13 w-full rounded-lam-md border border-(--color-neutral-border) bg-white py-[.85rem] pr-[2.9rem] pl-4.5 text-(length:--fs-body) leading-[1.6] text-lam-brown shadow-none transition-[border-color,box-shadow,background] duration-(--t-fast) ease-(--ease) placeholder:text-(--color-placeholder) hover:border-(--color-neutral-border) focus:border-lam-primary focus:bg-white focus:shadow-[0_0_0_3px_color-mix(in_srgb,var(--color-primary)_18%,transparent)] focus:outline-0 focus-visible:outline-0 [&.is-filled]:border-lam-primary [&.is-filled]:shadow-[0_0_0_3px_color-mix(in_srgb,var(--color-primary)_14%,transparent)] aria-invalid:border-lam-danger aria-invalid:bg-lam-surface aria-invalid:shadow-[0_0_0_4px_color-mix(in_srgb,var(--color-danger)_12%,transparent)]" id="cHeight" name="height" type="number" inputMode="numeric" dir="ltr"
                          min="100" max="220" step="1" placeholder="165" required />
                      </span>
                      <span className="text-(length:--fs-small) leading-normal font-bold text-lam-danger empty:hidden" data-err-for="cHeight"></span>
                    </p>
                  </div>

                  <p className="grid gap-[.45rem]">
                    <label className="text-(length:--fs-body) leading-normal font-(--w-body) text-lam-brown" htmlFor="cGoal">ما الذي ترغبين في تحقيقه؟ <span className="text-lam-primary" aria-hidden="true">*</span></label>
                    <span className="field-wrap relative block after:pointer-events-none after:absolute after:top-1/2 after:left-[1.1rem] after:z-1 after:h-[.65rem] after:w-[.65rem] after:-translate-y-1/2 after:rotate-45 after:border-r-[1.7px] after:border-b-[1.7px] after:border-lam-brown after:content-['']">
                      <select className="input min-h-13 w-full cursor-pointer appearance-none rounded-lam-md border border-(--color-neutral-border) bg-white py-[.85rem] pr-4.5 pl-11 text-right text-(length:--fs-body) leading-[1.6] text-lam-brown shadow-none transition-[border-color,box-shadow,background] duration-(--t-fast) [direction:rtl] ease-(--ease) hover:border-(--color-neutral-border) focus:border-lam-primary focus:bg-white focus:shadow-[0_0_0_3px_color-mix(in_srgb,var(--color-primary)_18%,transparent)] focus:outline-0 focus-visible:outline-0 [&.is-filled]:border-lam-primary [&.is-filled]:shadow-[0_0_0_3px_color-mix(in_srgb,var(--color-primary)_14%,transparent)] [&:has(option[value='']:checked)]:text-(--color-placeholder) aria-invalid:border-lam-danger aria-invalid:shadow-[0_0_0_4px_color-mix(in_srgb,var(--color-danger)_12%,transparent)] [&_option]:bg-lam-surface [&_option]:text-right [&_option]:text-lam-brown" id="cGoal" name="goal" required defaultValue="">
                    ...
                    <span className="text-(length:--fs-small) leading-normal font-bold text-lam-danger empty:hidden" data-err-for="goal"></span>
                  </p>

                  <p className="grid gap-[.45rem]">
                    <label className="text-(length:--fs-body) leading-normal font-(--w-body) text-lam-brown" htmlFor="cSource">كيف تعرّفتِ على <bdi className="lam" lang="en">Like A Model</bdi>؟ <span className="text-lam-primary" aria-hidden="true">*</span></label>
                    <span className="field-wrap relative block after:pointer-events-none after:absolute after:top-1/2 after:left-[1.1rem] after:z-1 after:h-[.65rem] after:w-[.65rem] after:-translate-y-1/2 after:rotate-45 after:border-r-[1.7px] after:border-b-[1.7px] after:border-lam-brown after:content-['']">
                    ...
                    <span className="text-(length:--fs-small) leading-normal font-bold text-lam-danger empty:hidden" data-err-for="source"></span>
                  </p>
                  <p className="mt-[.2rem] grid gap-[.45rem] [[hidden]]:hidden" id="sourceOtherField" hidden>
                    <label className="text-(length:--fs-body) leading-normal font-(--w-body) text-lam-brown" htmlFor="cSourceOther">يرجى توضيح كيف تعرّفتِ علينا <span className="text-lam-primary" aria-hidden="true">*</span></label>
                    <input className="input min-h-13 w-full rounded-lam-md border border-(--color-neutral-border) bg-white px-4.5 py-[.85rem] text-(length:--fs-body) leading-[1.6] text-lam-brown shadow-none transition-[border-color,box-shadow,background] duration-(--t-fast) ease-(--ease) placeholder:text-(--color-placeholder) hover:border-(--color-neutral-border) focus:border-lam-primary focus:bg-white focus:shadow-[0_0_0_3px_color-mix(in_srgb,var(--color-primary)_18%,transparent)] focus:outline-0 focus-visible:outline-0 [&.is-filled]:border-lam-primary [&.is-filled]:shadow-[0_0_0_3px_color-mix(in_srgb,var(--color-primary)_14%,transparent)] aria-invalid:border-lam-danger aria-invalid:bg-lam-surface aria-invalid:shadow-[0_0_0_4px_color-mix(in_srgb,var(--color-danger)_12%,transparent)]" id="cSourceOther" name="sourceOther" type="text" placeholder="يرجى التوضيح…" disabled />
                    <span className="text-(length:--fs-small) leading-normal font-bold text-lam-danger empty:hidden" data-err-for="cSourceOther"></span>
                  </p>

                  <p className="grid gap-[.45rem]">
                    <label className="text-(length:--fs-body) leading-normal font-(--w-body) text-lam-brown" htmlFor="cTime">متى الوقت المناسب للتواصل معكِ؟ <span className="text-lam-primary" aria-hidden="true">*</span></label>
                    <span className="field-wrap relative block after:pointer-events-none after:absolute after:top-1/2 after:left-[1.1rem] after:z-1 after:h-[.65rem] after:w-[.65rem] after:-translate-y-1/2 after:rotate-45 after:border-r-[1.7px] after:border-b-[1.7px] after:border-lam-brown after:content-['']">
                    ...
                    <span className="text-(length:--fs-small) leading-normal font-bold text-lam-danger empty:hidden" data-err-for="time"></span>
                  </p>

                  <p className="grid gap-[.45rem]">
                    <label className="text-(length:--fs-body) leading-normal font-(--w-body) text-lam-brown" htmlFor="cMessage">رسالتِك <span className="text-[.8438rem] text-lam-subtle">(اختياري)</span></label>
                    <textarea className="input min-h-24 w-full resize-y rounded-lam-md border border-(--color-neutral-border) bg-white px-4.5 py-4 text-(length:--fs-body) leading-[1.6] text-lam-brown shadow-none transition-[border-color,box-shadow,background] duration-(--t-fast) ease-(--ease) placeholder:text-(--color-placeholder) hover:border-(--color-neutral-border) focus:border-lam-primary focus:bg-white focus:shadow-[0_0_0_3px_color-mix(in_srgb,var(--color-primary)_18%,transparent)] focus:outline-0 focus-visible:outline-0 [&.is-filled]:border-lam-primary [&.is-filled]:shadow-[0_0_0_3px_color-mix(in_srgb,var(--color-primary)_14%,transparent)]" id="cMessage" name="message" rows="3" placeholder="أي تفاصيل تودّين إخبارنا بها…"></textarea>
                  </p>
              ...
              <aside className="relative mt-2 flex min-h-0 min-w-0 flex-col items-stretch justify-start border-t border-[color-mix(in_srgb,var(--color-brand-rose)_72%,transparent)] bg-transparent pt-6 shadow-none min-[760px]:mt-0 min-[760px]:min-h-full min-[760px]:border-0 min-[760px]:ps-10 min-[760px]:pt-0 min-[760px]:before:pointer-events-none min-[760px]:before:absolute min-[760px]:before:inset-y-13 min-[760px]:before:inset-s-0 min-[760px]:before:w-px min-[760px]:before:bg-[color-mix(in_srgb,var(--color-brand-rose)_72%,transparent)] min-[760px]:before:content-['']">
                <p className="mb-[.85rem] flex items-center justify-center gap-[.7rem] text-lam-primary" aria-hidden="true">
                  <span className="block h-px w-11 bg-current opacity-72"></span>
                  <svg className="ico h-3.25 w-3.25 fill-current stroke-none" aria-hidden="true"><use href="#i-heart"></use></svg>
                  <span className="block h-px w-11 bg-current opacity-72"></span>
                ...
                <div className="flex flex-none flex-col border-0 bg-transparent p-0 text-lam-muted shadow-none">
                  ...
                  <ul className="grid gap-3">
                    <li>
                      <a className="flex min-h-11 w-full items-center gap-[.8rem] py-0 text-start text-(length:--fs-body) leading-normal font-(--w-body) text-lam-brown transition-colors duration-(--t-fast) ease-(--ease) hover:text-lam-primary" href="tel:920031018" id="cPhoneLink" aria-label="الهاتف">
                        <span className="grid h-9 w-9 flex-none place-items-center rounded-lam-pill bg-(--color-brand-cream) text-lam-brown" aria-hidden="true"><svg className="ico h-[1.05rem] w-[1.05rem] text-current"><use href="#i-telephone"></use></svg></span>
                    ...
                    <li>
                      <a className="flex min-h-11 w-full items-center gap-[.8rem] py-0 text-start text-(length:--fs-body) leading-normal font-(--w-body) text-lam-brown transition-colors duration-(--t-fast) ease-(--ease) hover:text-lam-primary" href="#" id="cWaLink" rel="noopener" aria-label="الواتساب">
                        <span className="grid h-9 w-9 flex-none place-items-center rounded-lam-pill bg-(--color-brand-cream) text-lam-brown" aria-hidden="true"><svg className="ico h-[1.05rem] w-[1.05rem] text-current"><use href="#i-whatsapp"></use></svg></span>
                        <span className="grid min-w-0 gap-[.12rem]">
                    ...
                    <li>
                      <a className="flex min-h-11 w-full items-center gap-[.8rem] py-0 text-start text-(length:--fs-body) leading-normal font-(--w-body) text-lam-brown transition-colors duration-(--t-fast) ease-(--ease) hover:text-lam-primary" href="mailto:info@likeamodel.com.sa" id="cMailLink" aria-label="البريد الإلكتروني">
                        <span className="grid h-9 w-9 flex-none place-items-center rounded-lam-pill bg-(--color-brand-cream) text-lam-brown" aria-hidden="true"><svg className="ico h-[1.05rem] w-[1.05rem] text-current"><use href="#i-mail"></use></svg></span>
                        <span className="grid min-w-0 gap-[.12rem]">
                    ...
                    <li>
                      <span className="flex min-h-11 w-full items-center gap-[.8rem] py-0 text-start text-(length:--fs-body) leading-normal font-(--w-body) text-lam-brown">
                        <span className="grid h-9 w-9 flex-none place-items-center rounded-lam-pill bg-(--color-brand-cream) text-lam-brown" aria-hidden="true"><svg className="ico h-[1.05rem] w-[1.05rem] text-current"><use href="#i-pin"></use></svg></span>
                        <span className="grid min-w-0 gap-[.12rem]">
